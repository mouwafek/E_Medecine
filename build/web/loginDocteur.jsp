<%-- 
    Document   : loginDocteur
    Created on : 1 juin 2020, 11:05:48
    Author     : mou
--%>
...
<html>
    ...
    <body>
        ...
        <% //Récupération de message de succée d'inscription
            ...
            <form style="max-width: 620px; margin: auto;" class="text-center border border-light p-5" method="post" action="/E_Medecine/LoginDocteur">
                ...
                <p>Vous n'avez pas de compte?
                    <a href="inscriptionDocteur.jsp">S'inscrie</a>
                </p>
            </form>
            </main>
        <!-- Footer -->
