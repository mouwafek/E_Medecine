...
public final class poserMed_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write("        <title>Poser des médicaments</title>\n");
      ...
      out.write("            <br>\n");
      out.write("            ");
 //Réception de msg de succée d'erreur
...
out.println(erreur);
      ...
      out.write("                <div class=\"card\" style=\"margin-bottom: 25px;width: 40rem;\">\n");
      out.write("                    <div class=\"card-body\">\n");
      out.write("                        <form method=\"POST\" action=\"/E_Medecine/DepotMedicament\" enctype=\"multipart/form-data\">\n");
      out.write("                        <p class=\"card-title\" style=\"text-align: center;\">Déposer un médicament</p>\n");
      out.write("                        Nom du médicament :\n");
      out.write("                        <input name=\"nom\" type=\"text\" class=\"form-control\">\n");
      out.write("                        Forme pharmaceutique :\n");
      out.write("                        <input name=\"forme\" type=\"text\" class=\"form-control\">\n");
      out.write("                        Classe thérapeutque :\n");
      out.write("                        <div class=\"input-group mb-3\">\n");
      out.write("                            <select name=\"classe\" class=\"custom-select\" id=\"inputGroupSelect01\" required=\"\">\n");
      out.write("                                <option selected></option>\n");
      out.write("                                <option>Appareil digestif et métabolisme</option>\n");
      out.write("                                <option>Sang et organes hematopoietiques</option>\n");
      out.write("                                <option>Système cardiovasculaire</option>\n");
      out.write("                                <option>Médicament dermatologique</option>\n");
      out.write("                                <option>Système genito urinaire et hormones sexuelles</option>\n");
      out.write("                                <option>Hormones systèmiques, Hormones sexuelles exclues</option>\n");
      out.write("                                <option>Antiinfecieux généraux à usage systèmique</option>\n");
      out.write("                                <option>Antineoplastiques et immunomodulateurs</option>\n");
      out.write("                                <option>Muscle et squelette</option>\n");
      out.write("                                <option>Système nerveux</option>\n");
      out.write("                                <option>Antiparasitaire - Insecticides</option>\n");
      out.write("                                <option>Système respiratoire</option>\n");
      out.write("                                <option>Organes sensoriels</option>\n");
      out.write("                            </select>\n");
      out.write("                        </div>\n");
      out.write("                        Date de validité : \n");
      out.write("                        <input style=\"margin-bottom:20px; \" placeholder=\"Date de validité\" type=\"date\" id=\"example\" class=\"form-control\" name=\"dateval\" required=\"\">\n");
      out.write("                        Photo du médicament :\n");
      out.write("                        <input type=\"file\" name=\"ph\" class=\"form-control\" required=\"\">\n");
      out.write("                        <center><small id=\"defaultRegisterFormPasswordHelpBlock\" class=\"form-text text-muted mb-4\">\n");
      out.write("                            Il faut que la photo soit claire et porte le nom du médicament\n");
      out.write("                            </small></center>\n");
      out.write("                        Quantité :\n");
      out.write("                        <input type=\"number\" class=\"form-control\" name=\"qt\" required=\"\">\n");
      out.write("                        <input type=\"submit\" class=\"btn-success\" value=\"Déposer\">\n");
      out.write("                        </form>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </article>\n");
      ...
      out.write("                        <p class=\"card-title\" style=\"text-align: center;\">Déposer un médicament</p>\n");
      out.write("                        Nom du médicament :\n");
      out.write("                        <input name=\"nom\" type=\"text\" value=\"");
      out.print(m.getNomMed());
      out.write("\" class=\"form-control\">\n");
      out.write("                        Forme pharmaceutique :\n");
      out.write("                        <input name=\"forme\" type=\"text\" value=\"");
      ...
      out.write("\" placeholder=\"Date allergie\" type=\"date\" id=\"example\" class=\"form-control\" name=\"dateval\" required=\"\">\n");
      out.write("                        Photo : <br>\n");
      out.write("                        <img src=\"getMedImage.jsp?id=");
      out.print(m.getIdMed());
      out.write("\" style=\"width: 10rem;height: 5rem;\">\n");
      out.write("                        Charger un nouvelle photo du médicament :\n");
      out.write("                        <input type=\"file\" name=\"ph\" class=\"form-control\" required=\"\">\n");
      out.write("                        <center><small id=\"defaultRegisterFormPasswordHelpBlock\" class=\"form-text text-muted mb-4\">\n");
      out.write("                            Il faut que la photo soit claire et porte le nom du médicament\n");
      out.write("                            </small></center>\n");
